...
shirts=[cv2.imread("C://Smart-Trial-Room-gh-pages//static//assets//shirt1.png",-1),cv2.imread("C://Smart-Trial-Room-gh-pages//static//assets//shirt2.png",-1),cv2.imread("C://Smart-Trial-Room-gh-pages//static//assets//shirt51.jpg",-1),cv2.imread("C://Smart-Trial-Room-gh-pages//static//assets//shirt6.png",-1)]
for a in range(1,5):
    cv2.imshow('shirt'+str(a),shirts[a-1])
cv2.waitKey(1)
pants=[cv2.imread("C://Smart-Trial-Room-gh-pages//static//assets//pant7.jpg",-1),cv2.imread("C://Smart-Trial-Room-gh-pages//static//assets//pant21.png",-1)]
for b in range(1,3):
...
while True:        
    imgarr=["C://Smart-Trial-Room-gh-pages//static//assets//shirt1.png","C://Smart-Trial-Room-gh-pages//static//assets//shirt2.png","C://Smart-Trial-Room-gh-pages//static//assets//shirt51.jpg","C://Smart-Trial-Room-gh-pages//static//assets//shirt6.png",-]
    ...
    imgarr=["C://Smart-Trial-Room-gh-pages//static//assets//pant21.png"]
    #i=input("Enter the pant number you want to try")
